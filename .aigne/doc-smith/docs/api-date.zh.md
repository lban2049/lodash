...
Lodash 的日期函数专注于提供核心功能。有关更广泛的实用工具，请参阅 [工具函数 (Util)](./api-util.md) 和 [语言 (Lang)](./api-lang.md) 部分。
...
浏览完日期函数后，可以继续探索 [工具函数 (Util)](./api-util.md) 部分，了解更多通用的辅助函数。